...
Production CPF API endpoints are limited to **10 requests per 10 seconds per client IP**. Requests above this limit return HTTP `429` with this JSON body:
...
Clients should back off and retry after the current 10-second window.
