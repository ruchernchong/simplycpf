## [1.23.0](https://github.com/ruchernchong/simplycpf/compare/v1.22.2...v1.23.0) (2026-08-03)

### Features

* add accrued interest screen for oa used on a home ([a05a18f](https://github.com/ruchernchong/simplycpf/commit/a05a18f59e90e25702ea3b34ee1b8d99958dfab4))
* add API rate limiting ([1cbe3c6](https://github.com/ruchernchong/simplycpf/commit/1cbe3c6183453bca4defcbe215b14942a7e4c4de))
* add cpf at 55 screen ([1f6881a](https://github.com/ruchernchong/simplycpf/commit/1f6881a01c23cde8424c3e60c7d6f12654d2294f))
* add cpf self-check screen ([3e25152](https://github.com/ruchernchong/simplycpf/commit/3e251522f7438525a562c76abdb845c28950bab7))
* add oa accrued interest calculation ([8c87b49](https://github.com/ruchernchong/simplycpf/commit/8c87b49a329d6cf828ed37dc7136faf5213b5056))
* add projection inputs selector ([d14e04c](https://github.com/ruchernchong/simplycpf/commit/d14e04cb3735de253e31c73602a2cccaa25a37d5))
* add shared split bar, page header and stat band ([5c64d3c](https://github.com/ruchernchong/simplycpf/commit/5c64d3cb2c218eb710f77a82a8e8e4db0264358c))
* align globals.css with HeroUI theme shape and SimplyCPF tokens ([6d43aa7](https://github.com/ruchernchong/simplycpf/commit/6d43aa7afc5dc2b22a914bb87b4f2f3766cf5648))
* apply the brand kit to icons and og cards ([609f3d6](https://github.com/ruchernchong/simplycpf/commit/609f3d60e9e8fb486212d39a7f85e8d447cbb030))
* emit page schema in the html and close seo gaps ([68f2ce7](https://github.com/ruchernchong/simplycpf/commit/68f2ce71be8164d1d2b21d69fdfbc101d1d00763))
* let every screen take your own numbers ([339f61f](https://github.com/ruchernchong/simplycpf/commit/339f61fdb050317e0ffedd262b2280b703c75d12))
* migrate product headings and ledes to HeroUI Typography ([ebcec39](https://github.com/ruchernchong/simplycpf/commit/ebcec39f61696cb7a3c284de90a4cf67a3591c58))
* protect cheat sheet download with BotID ([4d75912](https://github.com/ruchernchong/simplycpf/commit/4d75912f247fdb5a1d96e222f1a6e76c5edc9499))
* rebuild calculator screen with heroui components ([b2efb8d](https://github.com/ruchernchong/simplycpf/commit/b2efb8d7ecb44289b18677dfff2f7e1d045439b2))
* rebuild cheat sheet as a printable reference card ([fc2aa88](https://github.com/ruchernchong/simplycpf/commit/fc2aa8814264a209ca9c1fa1c865e5a509fb41da))
* rebuild comparison screen as side-by-side columns ([9cab855](https://github.com/ruchernchong/simplycpf/commit/9cab8556e3991bf2dd4143ea0db6178a335f7cca))
* rebuild cpf life screen with three plan shapes ([c491559](https://github.com/ruchernchong/simplycpf/commit/c491559575cc046dfeee5d82352b3c7fd168b078))
* rebuild design tokens on heroui theme variables ([3d0e735](https://github.com/ruchernchong/simplycpf/commit/3d0e73537249e04a6f193940165778466a3e9e45))
* rebuild home page around the five questions ([f43767a](https://github.com/ruchernchong/simplycpf/commit/f43767a79cace73a6934935cc85b08bce362f15d))
* rebuild rates screen with contribution tables ([5202d91](https://github.com/ruchernchong/simplycpf/commit/5202d912b39f50b37e8e038c1c02a248d057f2cf))
* rebuild site header and footer for the new nav ([9aea6c5](https://github.com/ruchernchong/simplycpf/commit/9aea6c54c92e9ccf524287962fadb212b72bc60b))
* restore product UI with HeroUI OSS and Pro primitives ([17062de](https://github.com/ruchernchong/simplycpf/commit/17062de9e23b6ceb760f8d06c82fb4bd17275ee6))

### Bug Fixes

* address Greptile review on SEO KPI blocks ([3ae21d4](https://github.com/ruchernchong/simplycpf/commit/3ae21d47b0168820b932708328ac6e65af0deb17))
* address the review on the nav and shadcn migration ([b8b10e6](https://github.com/ruchernchong/simplycpf/commit/b8b10e6ce36b6d5c261944376e6a7de6e870c8f7))
* align Age 55+ KPI tile and Link mock with review feedback ([d4aa3bb](https://github.com/ruchernchong/simplycpf/commit/d4aa3bb71d68c9385b32883021edcd240ba353ec))
* align spacing and share the projection selector shallowly ([fe21fca](https://github.com/ruchernchong/simplycpf/commit/fe21fca1b2e1ae73f1baf35321b24098aa9c5cdf))
* anchor cpf life payouts to published cpf figures ([dabc3a3](https://github.com/ruchernchong/simplycpf/commit/dabc3a3ed9a4ed474ddcefa3839ae99d3fad841f))
* correct senior cpf rates to the 1 jan 2026 tables ([be7aecf](https://github.com/ruchernchong/simplycpf/commit/be7aecfd51ef5115941a7444197d7ec785d985e0))
* declare pnpm workspace package ([4e6d179](https://github.com/ruchernchong/simplycpf/commit/4e6d179b2cf89b250e62b28f38b7363c06436adb))
* derive the quoted ceiling from the data-as-of year ([6a2c111](https://github.com/ruchernchong/simplycpf/commit/6a2c11188b4caf8793f11796e2efc249776ab761))
* disable husky during semantic-release commits ([efeda04](https://github.com/ruchernchong/simplycpf/commit/efeda0469e2c89122df7f97fa5fe8e37939122ba))
* drop Typography render props and keep HomeConfusions as RSC ([a31b9be](https://github.com/ruchernchong/simplycpf/commit/a31b9bef165389a0c3f9fd09b561efbc01d43aa6))
* extract readiness questions data to clear Sonar duplication ([47a851b](https://github.com/ruchernchong/simplycpf/commit/47a851b41d04828af774e2897b7b6341d2aec46b))
* keep four shadcn primitives until their last consumers migrate ([8e67ba3](https://github.com/ruchernchong/simplycpf/commit/8e67ba3dc80587898eb65d75937a56632f05cfc2))
* pass HEROUI_AUTH_TOKEN to release install step ([04fa1de](https://github.com/ruchernchong/simplycpf/commit/04fa1debff6c8708b10805646f9e9f66ed51952c))
* pin number formatting to en-sg ([76fbc6e](https://github.com/ruchernchong/simplycpf/commit/76fbc6ed55ecdac0413dd8e5f327ebe3e9851542))
* pin react aria formatting to the en-sg locale ([a47bd14](https://github.com/ruchernchong/simplycpf/commit/a47bd14d9adc61ac2024be878ba38bfba21dbd6b))
* put the new header and footer spacing on the grid ([0d0cf05](https://github.com/ruchernchong/simplycpf/commit/0d0cf0586186e551e931ca68d739e5901d7efac2))
* put the shared primitives on the grid and type their returns ([dad5a30](https://github.com/ruchernchong/simplycpf/commit/dad5a300dddeec1d41d85976d14a81e6656067b7))
* reduce readiness form duplication for Sonar quality gate ([6438869](https://github.com/ruchernchong/simplycpf/commit/64388694ee5dc08fac47d82baf6aa1923f8a2c0d))
* restore gap between header and page body ([ae55d22](https://github.com/ruchernchong/simplycpf/commit/ae55d22d35e1218bcfaa5578d3dbbbdd977674fe))
* restore max-w on what-if scenario description ([6afeda8](https://github.com/ruchernchong/simplycpf/commit/6afeda86e2c1324df62f4e867a8d505c88c1d9cf))
* restore Vercel build and address Greptile review ([8aaa0ba](https://github.com/ruchernchong/simplycpf/commit/8aaa0baa1b2970ff89ea8a17af0ccbaa27635525))
* sort ceiling dates with an explicit comparator ([7719c49](https://github.com/ruchernchong/simplycpf/commit/7719c4973756e5b9bc2eec2c6e472e0a748c9f4b))
* store readiness questions in JSON to clear Sonar CPD ([a2d3df3](https://github.com/ruchernchong/simplycpf/commit/a2d3df3c3f98b54957ea4ef5402edf7c6b9494d8))
* treat 55 as the retirement account age, and align spacing ([d994a7b](https://github.com/ruchernchong/simplycpf/commit/d994a7ba411e630217bd2fc910e3f10e991a1554))
* update imports and finish src cleanup after renames ([e652840](https://github.com/ruchernchong/simplycpf/commit/e65284051f1deddaec9e14a7e276789ca12cebf2))
* use packageManager pnpm version in release workflow ([d13c157](https://github.com/ruchernchong/simplycpf/commit/d13c157790db6d2da4d1e99c87cdb07550c965a3))
* use RSC-safe KPI.Value in SEO statistic blocks ([2f905eb](https://github.com/ruchernchong/simplycpf/commit/2f905eb81c54c83f10c87b1cc6d04e1012c77b1a))
