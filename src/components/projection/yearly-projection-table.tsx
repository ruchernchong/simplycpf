    ...
    <Card>
      ...
      <Card.Content>
        <details className="group">
          <summary className="cursor-pointer rounded-2xl bg-surface-secondary px-4 py-4 font-medium text-foreground text-sm transition-colors hover:bg-surface-secondary">
